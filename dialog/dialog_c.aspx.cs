...
public partial class dialog_dialog_c : WebformGeneric
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack || MsgQueue == null)
        {
            ...
            if (Debug) SchoolInfo = Helper.FindSchool(Request.QueryString["id"] as string);
    ...
    protected void getThreadMessages()
    {
        ...
        SurveyStatus1.ParticipantId = ParticipantId;
